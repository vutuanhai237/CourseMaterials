...
namespace Bai1
{
    public partial class Form1 : Form
    {
        ...
        public static int i_buffer = 0;
        public static bool is_CtrlZ = false;
        //
        public Form1()
        {
            InitializeComponent();
        ...
        private void txt_TextChanged(object sender, EventArgs e)
        {
            ...
            if (!is_CtrlZ) buffer[++i_buffer] = txt.Text.ToString();
            is_CtrlZ = false;
            //Case new file
        ...
        public void PassResultFind(int index)
        {
            txt.Select(index, 0);
            txt.Focus();
            txt.ScrollToCaret();
        }
        public void PassResultReplace(string new_text)
        {
            txt.Text = new_text;
        }
        private void findToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            FindReplace fr = new FindReplace(txt.Text, this);
        ...
        {
            if (i_buffer > 0) i_buffer -= 1;
            txt.Text = buffer[i_buffer];
            is_CtrlZ = true;
        ...
        private void fontToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (FontDialog.ShowDialog() == DialogResult.OK)
            {
                if (txt.SelectedText.Length > 0)
                    txt.SelectionFont = FontDialog.Font;
                else
